#!/usr/bin/env python
"""
Module for training a Support Vector Machine (SVM) algorithm on captured features.
"""
...
training_set = pickle.load(open('./src/RoboND-Perception-Project/training_set.sav', 'rb'))
...
pickle.dump(model, open('./src/RoboND-Perception-Project/model.sav', 'wb'))
